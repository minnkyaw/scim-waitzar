A port of [WaitZar](http://waitzar.googlecode.com/) to run under [SCIM](http://www.scim-im.org/), an input manager that is used heavily in Ubuntu and to a greater or lesser extent in most Linux distros.
